<?php namespace App\Http\Controllers;
	...
	class AdminHistoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Texto','name'=>'text','type'=>'wysiwyg','validation'=>'required','width'=>'col-sm-9'];
